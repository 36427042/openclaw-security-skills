...
"""
⚠️ 已废弃（2026-05-11）
简创AIGC API已停用，源视频由天赐手动拍摄。

当前玉米工作模式:
天赐拍源视频 → 本地5国混剪（TTS+字幕+BGM+防重）
使用 composer_final.py 进行本地渲染
"""

import sys
print("=" * 60)
print("⚠️  video_pipeline_v2.py 已废弃")
print("简创AIGC API 已停用，源视频由天赐手动生成。")
print("请使用本地混剪脚本 composer_final.py")
print("=" * 60)
sys.exit(0)
